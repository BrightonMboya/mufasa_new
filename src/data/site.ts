...
export const journeys = [
  ...
  },
  {
    ...
    days: [
      { days: 'Day 01', place: 'Arusha', nights: 1, note: 'We will arrange for your pick up from the airport and transfer you to the hotel. There is an optional detour to Arusha city where you can explore the city and prepare for your tour the next day. Later in the evening, there will be a briefing session about your tour. You will also have the option to go for a small hike to Kilima Moto and enjoy the beautiful sunset view. Overnight at Tulia Boutique Hotel & Spa.', optional: false },
      { days: 'Day 02', place: 'Ngorongoro Highlands → Serengeti', nights: 1, note: "After breakfast, you will travel to the Serengeti National Park which is one of Africa's premier game parks. Driving through the Ngorongoro Conservation Area toward the Serengeti National Park, you will begin to experience the vastness of this territory and marvel at the multitude of animal and bird life while cruising through this acacia-spotted savannah. Overnight at Moyo Tented Camp.", optional: false },
      { days: 'Day 03', place: 'Serengeti — the Mara', nights: 1, note: 'Today, you will venture deeper into the world-famous Serengeti on a full-day game drive in search of the great wildebeest migration. Overnight at Moyo Tented Camp.', optional: false },
      { days: 'Day 04', place: 'Serengeti → Ngorongoro', nights: 1, note: 'Today, you will enjoy another full-day game drive in Central Serengeti. Overnight at Ngorongoro Serena Safari Lodge.', optional: false },
      { days: 'Day 05', place: 'Ngorongoro Crater', nights: 1, note: 'Today, you will be rewarded with a visit to the stunning Ngorongoro Crater, which became a UNESCO World Heritage Site in 1979. Overnight at Tulia Boutique Hotel & Spa.', optional: false },
  ...
  },
  {
    ...
    days: [
      { days: 'Day 01', place: 'Arusha', nights: 1, note: 'We will pick you up from the airport, then transfer you to the hotel with an optional detour to Arusha city to sightsee the city & prepare for your trip the next day. Overnight at Grand Melia Arusha.', optional: false },
      { days: 'Day 02', place: 'Tarangire', nights: 1, note: 'You will be picked up at 7:30 am and after being familiar with the guide, you will drive to Tarangire (a 2-hour drive), famous for its diverse landscape. Overnight at Maramboi Tented Lodge.', optional: false },
      { days: 'Day 03', place: 'Lake Manyara', nights: 1, note: 'After breakfast, you will enjoy the lodge seeing wildlife adjacent to the lodge then continue with activities outside of Lake Manyara visiting local farms. Overnight at Maramboi Tented Lodge.', optional: false },
      { days: 'Day 04', place: 'Ngorongoro', nights: 1, note: 'After breakfast, you will go to the Ngorongoro crater, you will descend this beautiful caldera & do a game drive in the early evening. Overnight at Ngorongoro Serena Safari Lodge.', optional: false },
      { days: 'Day 05', place: 'Serengeti', nights: 1, note: 'After breakfast, you will continue with the drive to Serengeti arriving in the early afternoon where you will check in at the lodge & relax. Overnight at Kubu Kubu Tented Lodge.', optional: false },
      { days: 'Day 06', place: 'Serengeti', nights: 1, note: 'On this day you will continue with an early morning game drive, with an option to go out the whole day or break up game drives. Overnight at Kubu Kubu Tented Lodge.', optional: false },
  ...
  },
  {
    ...
    days: [
      { days: 'Day 01', place: 'Arusha', nights: 1, note: 'Upon your arrival at Kilimanjaro International Airport, you will be warmly welcomed by our representative and transferred to your hotel in Arusha. Overnight at Njiro Legacy.', optional: false },
      { days: 'Day 02', place: 'Tarangire', nights: 1, note: 'After a hearty breakfast, you will embark on a scenic drive to Tarangire National Park. Known for its large elephant population and baobab trees, Tarangire offers a full day of game viewing. Overnight at Escarpment Luxury Lodge.', optional: false },
      { days: 'Day 03', place: 'Serengeti', nights: 1, note: 'Begin your day with an early breakfast before setting off on a journey to Serengeti National Park. The drive takes you through stunning landscapes, with opportunities for game viewing along the way. Overnight at Moyo Tented Camp.', optional: false },
      { days: 'Day 04', place: 'Serengeti', nights: 1, note: "Today is dedicated to exploring the vast plains of Serengeti National Park. You'll spend the entire day on a game drive, seeking out the Big Five and other incredible wildlife. Overnight at Moyo Tented Luxury Camp.", optional: false },
      { days: 'Day 05', place: 'Ngorongoro', nights: 1, note: "Start your day with an early morning game drive in Serengeti, followed by breakfast at the lodge. Afterward, you'll journey to the Ngorongoro Conservation Area. Overnight at Ngorongoro Lions Paw.", optional: false },
      { days: 'Day 06', place: 'Ngorongoro Crater', nights: 1, note: 'After an early breakfast, descend into the Ngorongoro Crater for a thrilling game drive. The crater is home to a diverse range of wildlife. Overnight at Gran Melia Arusha.', optional: false },
